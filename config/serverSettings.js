...
const devInnovationApi = devDefaults(
  "http://localhost:3001/api/kursinfo?defaultTimeout=10000"
); // required=true&
const devKursplanApi = devDefaults(
  "http://localhost:3001/api/kursplan?defaultTimeout=10000"
);
const devKoppsApi = devDefaults(
  "https://api-r.referens.sys.kth.se/api/kopps/v2/"
);
const devKursPmDataApi = devDefaults(
  "http://localhost:3001/api/kurs-pm-data?defaultTimeout=10000"
);
