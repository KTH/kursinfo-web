...
describe('Component <InfoModal> with html text 2I', () => {
  ...
  test('renders modal button with aria label', (done) => {
    ...
    expect(modalBtn.getAttribute('aria-label')).toBe('Information about choosing semester and course offering')

    done()
  })

  test('renders modal 2 close buttons if modal is open', async(done) => {
  ...
  test('renders modal heading and text included as html if modal is open', async(done) => {
    ...
    await waitFor(() =>
      {
        ...
        const stringFromHtml = queryByText('• A course goes different course offerings. To see information about a specific course offering, choose semester and course offering.')
...
describe('Component <InfoModal> and its functionality 3I', () => {
  ...
  test('open modal and close by clicking ×', async(done) => {
    ...
    setTimeout(async () =>  await waitForElementToBeRemoved(() => queryByText('Valid for')), 1000);
   

    done()
  })

  xtest('open modal and close by clicking button "Close"', async(done) => {
...
describe('Component <InfoModal> with non-html text 4I', () => {
  ...
  test('renders modal heading if modal is open', async(done) => {
    ...
    await waitFor(() =>
      {
        ...
        const string = queryByText('• A course goes different course offerings. To see information about a specific course offering, choose semester and course offering.')
