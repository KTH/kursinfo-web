...
class RoundInformationOneCol extends Component {
  ...
  render() {
    const { fade, courseHasRound, memoStorageURI, canGetMemoFiles, showRoundData, language = 1 } = this.props
    const round = this.props.courseRound || { round_course_term: [] }
    ...
    return (
      <span>
        {courseHasRound && showRoundData ? (
          <h2 id="courseRoundInformationHeader" style="margin-top:20px">
                ...
                {courseHasRound && showRoundData ? (
                  <span>
                    ...
                    <p className="clear-margin-bottom">
                      ...
                      {round ? round.round_start_date : EMPTY[this.props.language]}
                    </p>
                    <p>
                  ...
                  <span className="text-center2">
                    <h3 className="t4" id="roundHeader">
                      {i18n.messages[language].courseLabels.header_no_round_selected}
                    </h3>
                    ...
                    <h3 className="t4">
                      ...
                      {round /* && round.round_seats !== EMPTY[language] */ ? (
                        <InfoModal
                          ...
                          infoText={i18n.messages[language].courseLabels.round_seats_info}
                          closeLabel={i18n.messages[language].courseLabels.label_close}
                        />
                      ) : (
                        ''
                      )}
              ...
              {courseHasRound && showRoundData ? (
                <span>
                  <h2 id="applicationInformationHeader" className="right-column-header">
                    {i18n.messages[language].courseLabels.header_select_course}
                  </h2>
              ...
              {courseHasRound && showRoundData ? (
                <span>
                  <h2 id="contactInformationHeader" className="right-column-header">
                    {i18n.messages[language].courseLabels.header_contact}
                  </h2>
