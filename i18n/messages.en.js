module.exports = {
  ...
  courseLabels: {
    ...
    label_no_syllabus: 'Course syllabus missing, showing available courseinformation. Course rounds alsomissingfor current semester as wellas forpreviousand coming semesters',
